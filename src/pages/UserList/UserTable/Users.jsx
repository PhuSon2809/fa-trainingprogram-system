...
function descendingComparator(a, b, orderBy) {
    ...
    if (orderBy === "birthday") {
        const bdate = b[orderBy] !== null ? new Date(getBirthdate(b[orderBy])) : new Date();
        const adate = a[orderBy] !== null ? new Date(getBirthdate(a[orderBy])) : new Date();
        if (bdate < adate) {
            return -1;
        }
        if (bdate > adate) {
    ...
    return (
        <TableHead
            sx={{
                ...
                "tr:first-child th:first-child" : {borderTopLeftRadius: "10px"},
                "tr:first-child th:last-child" : {borderTopRightRadius: "10px"},
            }}    
        >
            <TableRow>
...
function Users() {
    ...
    const handleRequestSort = (event, property) => {
        console.log("reqSort has prop : " + property);
    ...
    const token =
        "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbkBnbWFpbC5jb20iLCJpYXQiOjE2NzA3NDI2NTgsImV4cCI6MTY3MDc0ODY1OH0.kh3B9u9_N69OwLehU-0SnZPiN2AzL3SKg2QTMfYwOGUXc9KEktZ6EovvwmzH4WlPb5jiGxgglXQlqvE2GHDrMg";
    ...
    useEffect(() => {
        axios
            .get(
                "http://ec2-13-212-157-122.ap-southeast-1.compute.amazonaws.com/api/v1/users?page=1&size=481",
                config
            )
            ...
            <div>
                ...
                <TableContainer>
                    <Table sx={{ marginTop: "40px" }} >
                        ...
                        />
                        {console.log(order + ": what order...->" + orderBy)}
                        <TableBody>
                            {
                            ...
                            .map((row) => (
                                ...
                                >
                                    ...
                                    <TableCell sx={{fontFamily:"inter",fontSize: "14px",lineHeight: "17px",fontWeight: 400}}>{row.email}</TableCell>
                                    <TableCell sx={{fontFamily:"inter",fontSize: "14px",lineHeight: "17px",fontWeight: 400}}>
                    ...
                    >
                        ...
                        <TablePagination
                            ...
                            sx = {{
                                ...
                                fontSize: "14px"},
                                "p.MuiTablePagination-displayedRows": {display: "none"} , 
